...
enumerate_hilbert := function(n)
  ...
  Exec(Concatenation(s, "hilbert", String(n), ".eprime"));

  f := IO_File(Concatenation("hilbert", String(n), ".eprime.info"), "r");
  done := false;
  ...
  Print("There are ", m, " hilbert algebras in ", mytime, "ms (=", StringTime(mytime), ")\n");
