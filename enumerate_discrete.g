...
enumerate_discrete := function(n)
  ...
  Exec(Concatenation(s, "discrete", String(n), ".eprime"));

  f := IO_File(Concatenation("discrete", String(n), ".eprime.info"), "r");
  done := false;
  ...
  Print("There are ", m, " discrete L-algebras in ", mytime, "ms (=", StringTime(mytime), ")\n");
